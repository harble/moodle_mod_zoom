...
$string['err_firstabletojoin_exceeds_global'] = 'The early join time cannot exceed the global setting value.';
...
$string['firstjoin_instance'] = 'First able to join';
$string['firstjoin_instance_help'] = 'Override the global "First able to join" setting for this specific meeting. Choose "Use global default" to inherit the site-wide setting.';
$string['defaultfirstabletojoin'] = 'Use global default ({$a} min)';
...
$string['recordingmethod'] = 'Recording Method';
$string['recordingmethod_cloud'] = 'Cloud Recording';
$string['recordingmethod_manual'] = 'Manual Upload';
$string['uploadrecording'] = 'Upload Recording';
$string['retransmitrecording'] = 'Retransmit Recording';
$string['deleterecording'] = 'Delete';
$string['recordingdeleted'] = 'Recording has been deleted.';
$string['recordinguploadsuccess'] = 'Recording has been uploaded successfully.';
$string['recordingfile'] = 'Recording File';
...
$string['recordingpasscode_help'] = 'Optional passcode for the recording. For manually uploaded recordings, this passcode is displayed as reference information for users and does not encrypt the file itself. Leave empty if no passcode is needed.';
...
$string['regionrestriction'] = 'Country/Region Access Restriction';
$string['regionrestrictionenabled'] = 'Enable country/region access restriction';
$string['regionrestrictionmethod'] = 'Restriction method';
$string['regionrestrictiondeny'] = 'Block the following countries/regions';
$string['regionrestrictionapprove'] = 'Allow only the following countries/regions';
$string['regionrestrictionlist'] = 'Country/Region';
$string['regionrestrictionlist_help'] = 'Select countries/regions to restrict access. Start typing to search.';
$string['regionrestrictionrequired'] = 'You must select at least one country/region when access restriction is enabled.';
$string['regionrestrictionmethodinvalid'] = 'Invalid restriction method selected.';
$string['regionrestriction:disabled'] = 'No restriction';
$string['reportduration'] = 'Duration';
$string['recordingvisibility'] = 'Are recordings for this meeting visible by default?';
$string['recordingvisibility_help'] = 'Whether the recording should be visible to ordinary users by default. If set to "Yes", all users can view this recording. If set to "No", only managers can see it. Visibility can be toggled later from the recordings list.';
...
$string['unavailablejoinwindow'] = 'Join window: {$a->from} to {$a->to}.';
$string['unavailablejoinpolicy'] = 'Join policy: Earliest join is {$a->mins} minutes before start; planned meeting duration is {$a->duration}.';
$string['unavailablenotstartedyet'] = 'The meeting has not started yet.';
$string['unavailabletimediffafter'] = 'Current time: {$a->now}; Started {$a->diff} ago.';
$string['unavailabletimediffbefore'] = 'Current time: {$a->now}; Starts in {$a->diff}.';
